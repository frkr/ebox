...
// TODO enviar email sem smtp
// export async function mail(emailFromFinal: string, content: string, msg: Message<MQEmail>, env: Env): Promise<MQEmailResponse> {
//
